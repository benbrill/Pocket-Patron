...
type Show = {
  ...
  last_updated_at: EpochTimeStamp;
  url: string;
}
...
const ShowComparison: React.FC = () => {
    ...
    const selectRandomPair = (data: Show[]) => {
        ...
        // Sort shows by last_updated_at (descending order)
        ...
        const show1 = sortedShows[0]; // The most recently updated show
    
        // Find a unique second show
        let show2: Show | null = null;
        const remainingShows = sortedShows.slice(1); // Exclude show1
