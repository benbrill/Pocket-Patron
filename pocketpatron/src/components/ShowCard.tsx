...
const ShowCard: React.FC<ShowCardProps> = ({ title, imageUrl, show_id, handleClick, active, season}) => {
    ...
    return (
        ...
        >
            ...
            <div className="show-card__content mx-1 pb-1">
                <div className='text-s font-mono text-muted-foreground leading-tight'>{season}</div>
